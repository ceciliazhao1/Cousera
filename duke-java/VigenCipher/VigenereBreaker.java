...
public class VigenereBreaker {
    ...
    public void breakVigenere () {
        ...
        * decrypted text.
        */
       FileResource f = new FileResource("data/secretmessage.txt");
        ...
        */
       int[] applykey = tryKeyLength(textToStr,4,'e');
    ...
    public void breakVigenere2(){
        FileResource text = new FileResource("data/secretmessage1.txt");
    ...
    public HashMap<String, HashSet<String>> langList(){
    ...
    public void breakVigenere3(){
        FileResource text = new FileResource("data/secretmessage.txt");
        langList();
        String testingFile = text.asString();
