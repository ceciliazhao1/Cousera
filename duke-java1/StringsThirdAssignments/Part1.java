...
public class Part1 {
    ...
    public void testquiz(){
        ...
        StorageResource newgenes= getAllGenes(contents);
        processGenes(newgenes);
    ...
    void testquiz2(){
        ...
        FileResource fr = new FileResource("dna/mansmall.fa");
        String Newdna = fr.asString();
        StorageResource newgenes= getAllGenes(Newdna);
        processGenes(newgenes);
    }
